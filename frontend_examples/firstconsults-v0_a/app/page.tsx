        ...
        >
          <ul className="grid gap-4 md:grid-cols-2">
            <li className="rounded border p-4">
              ...
              <p className="mt-1 text-sm text-slate-900/80">Clear milestones, shared trackers, and quick responses.</p>
            </li>
            <li className="rounded border p-4">
              <h3 className="font-medium">Personalized plans</h3>
              <p className="mt-1 text-sm text-slate-900/80">Every profile is unique—so is our guidance.</p>
            </li>
            <li className="rounded border p-4">
              <h3 className="font-medium">Timely mock reviews</h3>
              <p className="mt-1 text-sm text-slate-900/80">Practice interviews, SOP/LoR editing, and test feedback.</p>
            </li>
            <li className="rounded border p-4">
